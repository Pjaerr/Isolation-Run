...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			a.textContent = "here";
    			attr_dev(div0, "class", "modal-overlay svelte-1avjxvt");
    			...
    			attr_dev(button, "class", "svelte-1avjxvt");
    			add_location(button, file, 122, 8, 1983);
    			attr_dev(div1, "class", "header-back-button svelte-1avjxvt");
    			add_location(div1, file, 121, 6, 1941);
    			attr_dev(h1, "class", "svelte-1avjxvt");
    			add_location(h1, file, 131, 8, 2312);
    			attr_dev(div2, "class", "header-title svelte-1avjxvt");
    			add_location(div2, file, 130, 6, 2276);
    			attr_dev(header, "class", "header svelte-1avjxvt");
    			add_location(header, file, 120, 4, 1910);
    			attr_dev(em, "class", "svelte-1avjxvt");
    			add_location(em, file, 137, 8, 2452);
    			attr_dev(div3, "class", "body-intro svelte-1avjxvt");
    			...
    			attr_dev(div7, "class", "body-outro svelte-1avjxvt");
    			...
    			attr_dev(div8, "class", "body-tech svelte-1avjxvt");
    			add_location(div8, file, 171, 8, 3801);
    			attr_dev(div9, "class", "body-steps svelte-1avjxvt");
    			add_location(div9, file, 143, 6, 2699);
    			attr_dev(section0, "class", "body svelte-1avjxvt");
    			add_location(section0, file, 134, 4, 2375);
    			attr_dev(div10, "class", "modal svelte-1avjxvt");
    			add_location(div10, file, 119, 2, 1885);
    			attr_dev(section1, "class", "container svelte-1avjxvt");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file$2, 33, 0, 788);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "/");
    			add_location(a, file$3, 100, 2, 2216);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(100:0) {#if !phoneHasConnected}",
    		ctx
    	});
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 111, 2, 2485);
    			attr_dev(button, "class", "svelte-1wg9sjd");
    			add_location(button, file$3, 113, 2, 2586);
    		},
    		m: function mount(target, anchor, remount) {
    ...
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(104:0) {#if hasChosenVideo}",
    		ctx
    	});
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file$3, 107, 4, 2360);
    			attr_dev(h11, "class", "code svelte-1wg9sjd");
    			add_location(h11, file$3, 108, 4, 2425);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(105:2) {#if phoneHasConnected}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a.textContent = "Go back";
    			attr_dev(a, "href", "/");
    			add_location(a, file$4, 120, 2, 2697);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(120:0) {#if !desktopHasConnected}",
    		ctx
    	});
    ...
    // (124:0) {#if !socketIsOpen || !desktopHasConnected}
    function create_if_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(124:0) {#if !socketIsOpen || !desktopHasConnected}",
    		ctx
    	});
