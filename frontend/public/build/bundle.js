...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(script0, file, 15, 2, 345);
    			add_location(script1, file, 18, 2, 413);
    			...
    			add_location(iframe, file, 33, 0, 788);
    		},
    ...
    class Video extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { youtubeVideoID: 0 });
    ...
    const file$1 = "src\\Computer.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			h11 = element("h1");
    			h11.textContent = `${/*connectionCode*/ ctx[1]}`;
    			attr_dev(h10, "class", "svelte-pk7eo0");
    			add_location(h10, file$1, 99, 2, 2179);
    			attr_dev(h11, "class", "code svelte-pk7eo0");
    			add_location(h11, file$1, 100, 2, 2242);
    		},
    		m: function mount(target, anchor) {
    ...
    // (97:0) {#if phoneHasConnected}
    function create_if_block(ctx) {
    	let current;

    	const video = new Video({
    			props: { youtubeVideoID: "oSmUI3m2kLk" },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(97:0) {#if phoneHasConnected}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*phoneHasConnected*/ ctx[0]) return 0;
    		return 1;
    	}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let $isPaused;
    	validate_store(isPaused, "isPaused");
    	component_subscribe($$self, isPaused, $$value => $$invalidate(4, $isPaused = $$value));
    	let id = v4();
    		...
    		socket.onmessage = e => {
    			...
    			if (data.messageType === "connection") {
    				if (data.connectionCode === connectionCode) {
    					$$invalidate(0, phoneHasConnected = true);
    				...
    				$$invalidate(0, phoneHasConnected = false);
    				phoneWebSocketID = "";
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("phoneHasConnected" in $$props) $$invalidate(0, phoneHasConnected = $$props.phoneHasConnected);
    	};
    	...
    	return [phoneHasConnected, connectionCode];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (!/*socketIsOpen*/ ctx[2] || !/*desktopHasConnected*/ ctx[1]) return create_if_block$1;
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(em, file$3, 44, 6, 665);
    			add_location(h1, file$3, 42, 4, 633);
    			add_location(h2, file$3, 48, 4, 756);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$3, 36, 0, 523);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
